...
function injectUI(nonFollowers) {
    ...
    title.innerHTML = \`Twitter Non-Followers <span class="non-follower-title-count">\${nonFollowers.length}</span>\`;
    ...
    <div className="max-w-5xl mx-auto px-4 py-16 md:py-24" id="tutorial">
      ...
      >
        ...
        <h2 className="text-3xl md:text-4xl font-semibold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-sky-400">
          How to Find Non-Followers on Twitter
        </h2>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Follow these simple steps to discover who doesn't follow you back on Twitter.
        </p>
      </motion.div>
